                                        ...
                                        <div class="profile-user-info profile-user-info-striped">
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <input type="text" id="userName" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.userName"/>
                                                </div>
                                                <div class="profile-info-name"> 账户 </div>
                                                <div class="profile-info-value">
                                                    <input type="text" id="loginId" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.loginId"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <input type="text" id="userMobile" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.userMobile"/>
                                                </div>
                                                <div class="profile-info-name"> 办公地址 </div>
                                                <div class="profile-info-value">
                                                    <#--<i class="fa fa-map-marker light-orange bigger-110"></i>-->
                                                    <input type="text" id="workAddress" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.workAddress"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <input type="text" id="userJob" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.userJob"/>
                                                </div>
                                            </div>
                                            ...
                                            <div class="profile-info-row">
                                                ...
                                                <div class="profile-info-value">
                                                    <input type="text" id="userEmail" placeholder="Username" class="col-xs-10 col-sm-12" v-model="user.userEmail"/>
                                                </div>
